...
public class CalcUtil {
	...
	public static String penny2Yuan(String strMoney){
		if(StringUtil.isStrEmpty(strMoney)) return strMoney;
		BigDecimal doubleMoney = new BigDecimal(strMoney);
		return penny2YuanWithoutSN(doubleMoney)+"";
	}
	
	public static String yuan2Penny(String yuanMoney){
		if(StringUtil.isStrEmpty(yuanMoney)) return null;
		BigDecimal doubleMoney = new BigDecimal(yuanMoney);
		return roundUpWithoutSN(doubleMoney.multiply(new BigDecimal(100)),2).toString();
	}
	...
	public static String yuan2IntPenny(String yuanMoney){
		return yuan2IntPenny(yuanMoney, String.class);
	}
	
	public static <T> T yuan2IntPenny(String yuanMoney, Class<T> rtnclass){
		if(StringUtil.isStrEmpty(yuanMoney)) return null;
		return CommonUtil.parse(yuan2Penny(new Double(yuanMoney)), rtnclass);
	}
