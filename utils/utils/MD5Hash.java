...
/**
 * 此类的主要作用是对数据进行hash。提供给密码保护或者数据校验用。（来自xgd-common）
 * 创建时间：9:58:47
 * @author IceRao
 */
public class MD5Hash {
    ...
    public static String encryptPwd(String oriPwd){
        ...
        //将第一次的加密算法再作为key与原字符进行第二次加密
        //String passa=hash(oriPwd,key,"GBK");
        //String rtn = hash(passa,key,"GBK");
...
//        String str = "mypass/download/动.mp3192.168.1.10022";
//        String strutf8 = URLEncoder.encode(str, "utf-8");
//        System.out.println(strutf8);
//        System.out.println(hash(str, "", "utf-8"));
    	String pwd = "123456";
    	String s = encryptPwd(pwd);
