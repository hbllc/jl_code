...
public class HttpClientHelper {
	...
	private static CloseableHttpClient getClientInstance() {
		if (client == null) {
			synchronized (HttpClientHelper.class) {
				...
				if (client == null)
					client = HttpClientBuilder.create().setDefaultRequestConfig(requestConfig).setMaxConnPerRoute(20)// 设置每个路由的最大并发连接数为20以提高性能，默认为2
							.build();
			}
		}
		return client;
	 ...
	 * @throws IOException
	 */
	public static String httpPost(String url, String paramKey, String paramValue) throws ClientProtocolException, IOException {
	...
	public static String httpPost(String url, Map<String, String> params, String encode)
		...
		logger.info("[httpclient->url:"+url+"]请求参数:"+params);
		HttpResponse response = getClientInstance().execute(httpPost);
		HttpEntity entity = response.getEntity();
		String responseStr = EntityUtils.toString(entity);
		logger.info("[httpclient->url:"+url+"]返回:"+responseStr);
		return responseStr;
	}
	 ...
	 * @throws IOException
	 */
	public static String httpPostUseJsonBody(String url, String jsonBody, String encode,String contentType)
			throws ClientProtocolException, IOException {
		// 创建httpPost
		HttpPost httpPost = new HttpPost(url);
	...
	public static String httpPostUseJsonBody(String url, String jsonBody, String encode)
			throws ClientProtocolException, IOException {
		return httpPostUseJsonBody(url, jsonBody, encode, "application/json");
	}
	...
	public static void main1(String[] args) {
		...
		String fullurl = "http://172.20.0.82:8090/crm/api/machine/getAmMerchInfoByPage";
		Map<String, String> param = new HashMap<>();
		param.put("jsonparam", "{\"mechName\":\"\",\"userId\":\"100103\",\"pageno\":1,\"pagesize\":10,\"source\":\"3\"}");
		try {
	...
	public static void main(String[] args) {
		String fullurl = "http://172.20.0.82:8090/crm/api/mtagent/saveSalesAddInfo";
		String paramStr = "{\"name\":\"小吴04315\",\"loginNo\":\"3444444@163.com\",\"loginPhone\":\"17816855312\",\"loginEmail\":\"3444444@163.com\",\"agentId\":\"10032675\"}";
		Map<String, String> param = new HashMap<>();
		param.put("jsonparam", paramStr);
		try {
			String str = HttpClientHelper.httpPost(fullurl, param, ENCOCE_UTF_8);
			System.out.println(str);
		} catch (ClientProtocolException e) {
