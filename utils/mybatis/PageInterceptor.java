...
public class PageInterceptor implements Interceptor {
    ...
    /** 默认DB方言 */
    private static final String DEFAULT_DIALECT = "oracle";
    ...
    private StringBuffer buildPageSqlForOracle(String sql, PageQuery page) {
    	StringBuffer pageSql = new StringBuffer();
    	int beginrow = (page.getPageIndex() - 1) * page.getPageSize();
    	pageSql.append("select * from ( select temp.*, rownum row_id from ( ");  
        pageSql.append(sql);  
        pageSql.append(" ) temp where rownum <= ").append(beginrow+page.getPageSize());  
